...
int resume(char* path, int fd_out, int jobid, int max_jobs)
{
	int i, j = 0;
	int max = max_jobs;
	...
	{ 
		...
		{ 
			...
			{ perror("Command resume: Error writing to console"); }
